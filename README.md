# ze2 - zonble 魔改過的 Microsoft Edit 編輯器

這個專案基於微軟的命令列文字編輯軟體 edit 進行魔改，結合現代 Rust 效能、中文寫作需求與九零年代元素。

魔改這個編輯器的起因是，在 AI 時代、愈來愈多工作在終端機完成時，我想一套在終端機下更順手的寫作工具，不用另外切換到其他的桌面編輯軟體。同時，目前流行的各種常見文書軟體，也不符合我在寫作時的額外需求。
...
```shell
cargo install --git https://github.com/zonble/ze2.git ze2
```
